...
function applyRolePermissions(){
  ...
  const selectors=['[data-action="new-party"]','[data-action="new-project"]','[data-action="new-invoice"]','[data-action="new-material"]','[data-action="new-purchase"]','[data-action="new-supplier"]','[data-action="new-purchase-bill"]','[data-action="new-walk-in-order"]','[data-action="new-payment-account"]','[data-action="new-payment"]','[data-action="record-receipt"]','[data-action="record-expense"]','[data-action="add-labourer"]','[data-action="assign-labour"]','[data-action="assign-operation-material"]','[data-edit-party]','[data-party-project]','[data-edit-project-card]','[data-edit-order-card]','[data-edit-material-card]','[data-edit-labourer]','[data-purchase-material]','[data-pay-purchase-bill]','#editProjectBtn','#approveProjectBtn','#cancelProjectBtn','#scopeIncreaseBtn','#scopeDecreaseBtn','#generateProjectInvoiceBtn','#editMaterialBtn','#purchaseMaterialBtn','#payPurchaseBillBtn','#editWalkInOrderBtn','#advanceWalkInOrderBtn','#cancelWalkInOrderBtn','#editPaymentAccountBtn','#accountMoneyInBtn','#accountMoneyOutBtn','#accountTransferBtn','#editInvoiceBtn','#receiveInvoicePaymentBtn'];selectors.forEach(selector=>$$(selector).forEach(el=>el.classList.toggle('role-hidden',!writable)));
}
